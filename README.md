...
1. Downloading a copy of [The common Ansible role template release archive](https://gitlab.com/the-common/ansible-role-template/-/releases)
1. Extract The common Ansible role template release archive to a temporary directory
...
1. Click the ["Use this template" green button](https://github.com/the-common/ansible-role-template/generate) on [the mirrored GitHub project page](https://github.com/the-common/ansible-role-template)
